...
class Main extends Component {
  ...
  componentDidMount() {
    ...
    // 지금뜨는프립
    fetch("http://127.0.0.1:8000/frip?tag=hotfrip&limit=4")
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          hotFrip: res.data,
    ...
    // 프립특가 놓치지 마세요
    fetch("http://127.0.0.1:8000/frip?tag=sale&limit=4")
      .then((res) => res.json())
      .then((res) => {
        this.setState({
    ...
    // 5월 슈퍼호스트
    fetch("http://127.0.0.1:8000/frip?tag=superhost&limit=4")
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          superHost: res.data,
    ...
    //내손으로 만드는 재미
    fetch("http://127.0.0.1:8000/frip?tag=enjoy&limit=4")
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          enjoy: res.data,
    ...
    //신규 프립
    fetch("http://127.0.0.1:8000/frip?tag=newfrip&limit=4")
      .then((res) => res.json())
      .then((res) => {
        this.setState({
          newFrip: res.data,
